...
const AddTimeModal = ({ initialDateTime, onSave, onClose, accentColor }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex items-start justify-center bg-black/70 px-4 transition-all"
      onClick={onClose}
    >
      <div
        className="relative mt-24 w-full max-w-[360px] rounded-[2rem] border border-[var(--border)] p-6 shadow-2xl transition-transform"
        style={{
          background:
