...
export default function App() {
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      "--bg-gradient-end",
      currentTheme.backgroundGradient[1],
    );
    ...
    root.style.setProperty(
      "--accent-primary",
      currentTheme.accentPrimary || currentTheme.accentAH,
    );
    ...
    root.style.setProperty(
      "--timeline-bg-start",
      currentTheme.timelineBackground[0],
    );
    root.style.setProperty(
      "--timeline-bg-end",
      currentTheme.timelineBackground[1],
    );
    root.style.setProperty(
      "--timeline-bg-alt-start",
      currentTheme.timelineSecondaryBackground[0],
    );
    root.style.setProperty(
      "--timeline-bg-alt-end",
      currentTheme.timelineSecondaryBackground[1],
    );
    ...
    root.style.setProperty(
      ...
      isDark ? currentTheme.accentAH : "rgba(255,255,255,0.3)",
    );
    root.style.setProperty("--header-gradient-ei-start", currentTheme.accentEI);
    root.style.setProperty(
      "--header-gradient-ei-end",
      isDark ? currentTheme.accentEI : "rgba(255,255,255,0.3)",
    );
  ...
  return (
    <div
      className="h-screen w-screen overflow-y-auto overflow-x-hidden flex flex-col transition-colors duration-500"
      style={{
      ...
      {showSettings && (
        ...
        >
          ...
          >
            ...
            <div className="mb-3">
              <h4 className="text-xs font-black text-[var(--text-secondary)] uppercase tracking-[0.3em]">
                Theme
              </h4>
            </div>
